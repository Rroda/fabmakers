...
| H7 | Makers (e donos de impressora) pagam por **manutenção**: oficinas, peças, manuais/vídeos de reparo | Landing/entrevistas: zero intenção de pagar ou achar técnico via FabMakers | open — backlog **L2** (ROADMAP); não UI até Core estável |
| H8 | **Dropshipping** como origem de demanda (fulfillment local) escala a fila sem virar o posicionamento | Se o pitch depender de Shopee/afiliado, H8 falha como risco de narrativa | open — backlog **L3** |
| H9 | **Designers** + royalties fecham o lado da oferta de modelos depois do matching de fabs | Sem fabs/jobs, designers churn | open — backlog **L1** |
